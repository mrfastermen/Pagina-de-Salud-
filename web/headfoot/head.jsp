        ...
        <div id="wrapper">
            ...
            <nav class="navbar navbar-default navbar-static-top encabezado" role="navigation" style="margin-bottom: 0">
                ...
                <ul class="nav navbar-top-links navbar-right">
                    ...
                    <li class="dropdown">
                        <a class="dropdown-toggle" data-toggle="dropdown" href="#">
                            <label id="nombreUser"><%=nombre%></label><i class="fa fa-caret-down"></i>
                ...
                <div class="navbar-default sidebar" role="navigation">
                    <div class="sidebar-nav navbar-collapse">
                        <ul class="nav" id="side-menu">
                            ...
                            <div id="accordion">
                                <h3>
                                    <a class="active" href="../SaludGratisPW/pages/consultas.jsp"><i class="fa fa-files-o fa-fw"></i> Consultas</a>
                                </h3>
                                <div></div>
                                <h3>
                                    <a href="#"><i class="fa fa-book fa-fw"></i> Citas medicas<span class="fa arrow"></span></a>
                                </h3>
                                <div>
                                    <ul>
                                        <li>
                                            <a href="../SaludGratisPW/pages/crearCita.jsp">Crear cita</a>
                                        </li>
                                        <li>
                                            <a href="../SaludGratisPW/pages/cancelarCita.jsp">Cancelar cita</a>
                                        </li>
                                    </ul>
                                </div>
                            </div>
